...
namespace IOAS.DataModel
{
    ...
    public partial class tblRCTConsultantExperienceDetailLog
    {
        public int ConsultantExperienceDetailLogId { get; set; }
        public Nullable<int> ConsultantAppointmentLogId { get; set; }
        public Nullable<int> ConsultantExperienceDetailId { get; set; }
