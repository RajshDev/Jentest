...
namespace IOAS.DataModel
{
    ...
    public partial class tblAdminVoucherPaymentBreakUpDetail
    {
        public int AdminVoucherPaymentBreakUpDetailId { get; set; }
        public Nullable<int> AdminVoucherId { get; set; }
