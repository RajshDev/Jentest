...
namespace IOAS.DataModel
{
    ...
    public partial class syncobj_0x3930354536453943
    {
        ...
        public Nullable<int> LCRetireSeqNumber { get; set; }
        public string LCForgnCurrValueinWords { get; set; }
        public string LCRetireReferenceNumber { get; set; }
