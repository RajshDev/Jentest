...
namespace IOAS.DataModel
{
    ...
    public partial class syncobj_0x4231313531384434
    {
        ...
        public string TempPI { get; set; }
        public string TempCopI1 { get; set; }
        public string TempCopI2 { get; set; }
        public string TempAgencyCode { get; set; }
        public Nullable<int> ProposalClassification { get; set; }
        public Nullable<int> SponsoredProposalType { get; set; }
        public Nullable<int> SponsoredProposalTypeCode { get; set; }
        public Nullable<int> ConsultancyProposalType { get; set; }
