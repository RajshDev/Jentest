...
namespace IOAS.DataModel
{
    ...
    public partial class vw_RCTCONEmployeeMaster
    {
        ...
        public Nullable<int> MedicalAmmount { get; set; }
        ...
        public Nullable<int> CasteCategory { get; set; }
        public Nullable<int> BloodGroup { get; set; }
        public Nullable<int> FullorPart { get; set; }
        ...
        public Nullable<int> ConsolidatedPay { get; set; }
        public Nullable<int> Fellowship { get; set; }
        ...
        public string isGovAgencyFund { get; set; }
