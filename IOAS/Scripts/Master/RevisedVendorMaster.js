$(function () {
    var GetVendorlist = 'GetRevisedVendorMaster',
        RevisedEditVendorlist = 'RevisedEditVendorlist',
                  ...
                  { name: "Status", title: "Status", editing: false, align: "left", width: 60 },
             {
                 ...
                 itemTemplate: function (value, item) {
                     ...
                     if (item.Status == "Active") {
                         statusList = [{ id: "", name: "Select Action" }, { id: "Edit", name: "Revised" }, { id: "View", name: "View" }]
                     }
                     else {
                     ...
                     $customSelect.change(function (e) {
                         var selVal = $(this).val();
                         if (selVal == "Edit") {
                             editVendor(item.VendorId)
                         }
                        
                         else if (selVal == "View") {
                             var url = 'VendorManagementView?Vendorid=' + item.VendorId;
    ...
    function editVendor(vendorid) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('#ddlBankcountry').val(result.BankCountry);
                ...
                $.each(Docgstname, function (i, doc) {
                    if (i == 0) {
                        ...
                        document.getElementsByClassName('link1')[i].href = "ShowDocument?file=" + gstDocpath[i] + "&filepath=~%2FContent%2FGstDocument%2F";
                    }
                });
                ...
                $.each(Docvendorname, function (i, doc) {
                    if (i == 0) {
                        ...
                        document.getElementsByClassName('link2')[0].href = "ShowDocument?file=" + vendorDocpath[0] + "&filepath=~%2FContent%2FReverseTaxDocument%2F";
                    }
                    else {
